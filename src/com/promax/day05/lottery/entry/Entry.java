package com.promax.day05.lottery.entry;

import com.promax.day05.lottery.domain.Awards;
...
//        System.out.println(binarySearch(awards, 6).getName());
        ...
        for (int i = 0; i < 100; i++) {
            System.out.println("恭喜chy女士获得：" + binarySearch(awards, random.nextInt(10)).getName());
        }
    }
